...
class CreateStudentMigrationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('student_migrations', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('to_course_id')->nullable()->index('student_migrations_to_course_id_foreign');
            $table->unsignedBigInteger('from_batch_id')->nullable();
            $table->unsignedBigInteger('to_batch_id')->nullable()->index('student_migrations_to_batch_id_foreign');
