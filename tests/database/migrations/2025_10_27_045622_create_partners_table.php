...
class CreatePartnersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('partners', function (Blueprint $table) {
            ...
            $table->string('upazila')->nullable()->index('partners_upazila_foreign');
            ...
            $table->string('owner_director_contact')->nullable();
            ...
            $table->text('short_address_bangla')->nullable();
            $table->longText('course_offers')->nullable();
            $table->timestamps();
        });
    }
