...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        <form action="{{ route('partner.questions.descriptive.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div>
                <label for="expected_answer_points" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Expected Answer Points</label>
                <textarea name="expected_answer_points" id="expected_answer_points" rows="4" 
                          ...
                          placeholder="List the key points that should be covered in the answer...">{{ old('expected_answer_points') }}</textarea>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">List the main points or concepts that students should address in their answer</p>
                @error('expected_answer_points')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <textarea name="sample_answer" id="sample_answer" rows="8" 
                          class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primaryGreen focus:ring-primaryGreen"
                          placeholder="Provide a model answer for reference...">{{ old('sample_answer') }}</textarea>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">A comprehensive answer that demonstrates the expected level of detail and understanding</p>
                @error('sample_answer')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="min_words" id="min_words" min="10" max="1000" 
                           class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primaryGreen focus:ring-primaryGreen"
                           value="{{ old('min_words', 50) }}" placeholder="50">
                    @error('min_words')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="max_words" id="max_words" min="50" max="2000" 
                           class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primaryGreen focus:ring-primaryGreen"
                           value="{{ old('max_words', 300) }}" placeholder="300">
                    @error('max_words')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="marks" id="marks" min="1" max="20" required 
                           class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-primaryGreen focus:ring-primaryGreen"
                           value="{{ old('marks', 5) }}">
                    @error('marks')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
