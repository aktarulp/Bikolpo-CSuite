...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        console.log('Last clicked button value:', lastClickedButton ? lastClickedButton.value : 'undefined');
        
        // Use e.submitter if available, otherwise fall back to our tracking
        const submitButton = e.submitter || lastClickedButton;
        console.log('Submit button:', submitButton);
        console.log('Submit button value:', submitButton ? submitButton.value : 'undefined');
        
        if (submitButton && submitButton.value === 'draft') {
            console.log('Processing draft submission');
            ...
            console.log('Processing publish submission');
        }
