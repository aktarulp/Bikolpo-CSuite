...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <div class="max-w-4xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update your exam configuration and settings</p>
                </div>
        ...
        <!-- Form -->
        <form id="examForm" action="{{ route('partner.exams.update', $exam) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="startDateTime" name="startDateTime" 
                                   value="{{ old('startDateTime', $exam->start_time ? $exam->start_time->format('Y-m-d\TH:i') : now()->addHours(2)->format('Y-m-d\TH:i')) }}" required 
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">📅 Choose a future date and time</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="endDateTime" name="endDateTime" 
                                   value="{{ old('endDateTime', $exam->end_time ? $exam->end_time->format('Y-m-d\TH:i') : now()->addHours(4)->format('Y-m-d\TH:i')) }}" required 
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white transition-colors" 
                                   onchange="validateDateTime()">
                        ...
                        <div class="form-group">
                            <div class="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div id="negativeMarkingPlaceholder" class="{{ old('has_negative_marking', $exam->has_negative_marking) ? 'hidden' : '' }} text-xs text-gray-400">
                                        -
                                    </div>
                                </div>
                            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                <div class="flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
                    <div class="text-center sm:text-left">
                        <h3 class="text-sm font-medium text-gray-900 dark:text-white">Ready to update your exam?</h3>
