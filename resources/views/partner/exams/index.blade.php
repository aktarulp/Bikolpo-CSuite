...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-4">
    <div class="max-w-7xl mx-auto space-y-3">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <div class="flex flex-row gap-3 items-center">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-3 border border-gray-200 dark:border-gray-600 flex-1">
                        <form method="GET" action="{{ route('partner.exams.index') }}" id="filterForm" class="flex flex-row gap-2">
                            <div class="relative flex-1">
                                ...
                                <input type="text" name="q" id="searchInput" value="{{ request('q') }}" placeholder="Search exams..." class="pl-8 pr-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-primaryGreen focus:border-transparent transition-all duration-200 w-full" />
                            </div>
                            <select name="status" id="statusSelect" class="px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primaryGreen focus:border-transparent transition-all duration-200 text-sm min-w-32">
                    ...
                    <a href="{{ route('partner.exams.create') }}" 
                       class="inline-flex items-center gap-2 bg-gradient-to-r from-primaryGreen to-emerald-500 hover:from-emerald-500 hover:to-primaryGreen text-white px-4 py-2 rounded-xl font-semibold transition-all duration-200 transform hover:scale-105 hover:shadow-xl shadow-lg text-sm whitespace-nowrap">
        ...
        <div class="grid grid-cols-5 gap-2">
            <div class="bg-white dark:bg-gray-800 rounded-lg p-2 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs font-medium text-gray-600 dark:text-gray-400">Total</p>
                        <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $counts['all'] ?? 0 }}</p>
                    </div>
                    <div class="w-6 h-6 bg-gray-100 dark:bg-gray-700 rounded-md flex items-center justify-center">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-2 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $counts['draft'] ?? 0 }}</p>
                    </div>
                    <div class="w-6 h-6 bg-gray-100 dark:bg-gray-700 rounded-md flex items-center justify-center">
                        <svg class="w-3 h-3 text-gray-600 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-2 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-bold text-green-600 dark:text-green-400">{{ $counts['published'] ?? 0 }}</p>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-2 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-bold text-blue-600 dark:text-blue-400">{{ $counts['ongoing'] ?? 0 }}</p>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-2 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-lg font-bold text-purple-600 dark:text-purple-400">{{ $counts['completed'] ?? 0 }}</p>
                    </div>
