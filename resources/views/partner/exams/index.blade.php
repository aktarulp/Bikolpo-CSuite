            ...
            <div class="flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between relative z-10">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                    ...
                    <div class="flex-1 lg:flex-initial">
                        <form method="GET" action="{{ route('partner.exams.index') }}" id="filterForm" class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('partner.exams.create') }}" 
                       class="group relative inline-flex items-center justify-center gap-2 bg-gradient-to-r from-primaryGreen via-emerald-500 to-teal-500 hover:from-teal-500 hover:via-emerald-500 hover:to-primaryGreen text-white px-6 py-3 rounded-xl font-bold transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg overflow-hidden">
                                ...
                                <tr class="hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-indigo-50/50 dark:hover:from-gray-700/30 dark:hover:to-slate-700/30 transition-all duration-300 group border-b border-gray-100 dark:border-gray-700/30">
                                    ...
                                    <td class="px-6 py-5">
                                        <div class="flex flex-col">
                                            <a href="{{ route('partner.exams.show', $exam) }}" class="text-base font-bold text-gray-900 dark:text-white hover:text-primaryGreen dark:hover:text-primaryGreen transition-colors duration-200 line-clamp-1">
                                                {{ $exam->title }}
                                            </a>
