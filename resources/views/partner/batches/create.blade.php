...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Create New Batch</h1>
            <p class="text-gray-600 dark:text-gray-400">Add a new batch to your coaching center</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
        ...
        <form action="{{ route('partner.batches.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
                ...
                <div>
                 ...
                 <div>
                     ...
                     <input type="number" id="year" name="year" value="{{ old('year') }}" required min="2000" max="2030"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primaryGreen focus:border-primaryGreen dark:bg-gray-700 dark:text-white"
