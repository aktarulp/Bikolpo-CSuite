                    ...
                    <div class="space-y-3">
                        <label class="flex items-center">
                            <input type="checkbox" name="permission_inheritance" class="rounded border-gray-300 text-primaryGreen shadow-sm focus:border-primaryGreen focus:ring-primaryGreen dark:border-gray-600 dark:bg-gray-700" 
                                   {{ $defaultSettings['permission_inheritance'] ?? false ? 'checked' : '' }}>
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="inherit_parent_permissions" class="rounded border-gray-300 text-primaryGreen shadow-sm focus:border-primaryGreen focus:ring-primaryGreen dark:border-gray-600 dark:bg-gray-700"
                                   {{ $defaultSettings['inherit_parent_permissions'] ?? false ? 'checked' : '' }}>
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="allow_permission_overrides" class="rounded border-gray-300 text-primaryGreen shadow-sm focus:border-primaryGreen focus:ring-primaryGreen dark:border-gray-600 dark:bg-gray-700"
                                   {{ $defaultSettings['allow_permission_overrides'] ?? false ? 'checked' : '' }}>
                    ...
                    <div class="space-y-3">
                        <label class="flex items-center">
                            <input type="checkbox" name="log_permission_changes" class="rounded border-gray-300 text-primaryGreen shadow-sm focus:border-primaryGreen focus:ring-primaryGreen dark:border-gray-600 dark:bg-gray-700"
                                   {{ $defaultSettings['log_permission_changes'] ?? false ? 'checked' : '' }}>
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="track_user_access" class="rounded border-gray-300 text-primaryGreen shadow-sm focus:border-primaryGreen focus:ring-primaryGreen dark:border-gray-600 dark:bg-gray-700"
                                   {{ $defaultSettings['track_user_access'] ?? false ? 'checked' : '' }}>
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="notify_security_events" class="rounded border-gray-300 text-primaryGreen shadow-sm focus:border-primaryGreen focus:ring-primaryGreen dark:border-gray-600 dark:bg-gray-700"
                                   {{ $defaultSettings['notify_security_events'] ?? false ? 'checked' : '' }}>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" id="session_timeout" name="session_timeout" value="{{ $defaultSettings['session_timeout'] ?? 30 }}" min="5" max="480" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-primaryGreen focus:border-primaryGreen dark:bg-gray-700 dark:text-white">
                    </div>
                    <div>
                        ...
                        <input type="number" id="max_sessions" name="max_sessions" value="{{ $defaultSettings['max_sessions'] ?? 3 }}" min="1" max="10" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-primaryGreen focus:border-primaryGreen dark:bg-gray-700 dark:text-white">
                    </div>
                    <div>
                        <label for="idle_timeout" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Idle Timeout (minutes)</label>
                        <input type="number" id="idle_timeout" name="idle_timeout" value="{{ $defaultSettings['idle_timeout'] ?? 15 }}" min="5" max="120" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-primaryGreen focus:border-primaryGreen dark:bg-gray-700 dark:text-white">
                    </div>
                </div>
                
                <div class="flex justify-end mt-6">
                    <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-primaryGreen hover:bg-primaryGreen/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primaryGreen transition-colors duration-200">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        Save Settings
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                ...
                <button onclick="importPermissions()" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-lg text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primaryGreen transition-colors duration-200">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function addNewRole() {
    ...
    const parent = document.getElementById('new_role_parent').value;
...
function importPermissions() {
    // Here you would typically open a file picker and import permissions
