            ...
            <div class="lg:col-span-3 space-y-6">
                ...
                <form action="{{ route('partner.teachers.assignments.update', $teacher) }}" method="POST">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
                        ...
                        <div class="p-6">
                            @if($students->count() > 0)
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-h-64 overflow-y-auto">
                    ...
                    <!-- Batches Assignment -->
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
                        <div class="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Batch Assignments</h3>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Select batches for this teacher</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-6">
                                    ...
                                    @foreach($batches as $batch)
                                        <label class="flex items-center p-3 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ $batch->students->count() }} students</p>
                                            </div>
                                        </label>
                                    @endforeach
                                </div>
                            @else
                                <p class="text-gray-500 dark:text-gray-400 text-center py-4">No batches available</p>
                            @endif
                        </div>
                    </div>
