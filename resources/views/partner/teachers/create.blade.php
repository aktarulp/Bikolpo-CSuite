...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-900">
    <div class="container mx-auto px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-4 mb-6">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400 mt-1">
                        Create a comprehensive teacher profile with all necessary information
                    </p>
                </div>
            </div>
        ...
        <!-- Form -->
        <form action="{{ route('partner.teachers.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8" id="teacher-form">
            @csrf
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="teacher_id" id="teacher_id" required value="{{ old('teacher_id') }}"
                        ...
                        <div class="relative md:col-span-2 lg:col-span-1">
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Max size: 2MB. Formats: JPG, PNG</p>
                            @error('photo')
                                <p class="mt-1 text-xs text-red-600 flex items-center gap-1">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="relative">
                            ...
                            <select name="emergency_contact_relation" id="emergency_contact_relation" required
                                ...
                                <option value="Son" {{ old('emergency_contact_relation') == 'Son' ? 'selected' : '' }}>Son</option>
                                <option value="Daughter" {{ old('emergency_contact_relation') == 'Daughter' ? 'selected' : '' }}>Daughter</option>
