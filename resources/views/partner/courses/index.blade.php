...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6 flex flex-col sm:flex-row gap-4">
            ...
            <div class="sm:w-48">
                <select id="filterSelect" class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
            ...
            <div class="flex">
                ...
                <div class="ml-auto pl-3">
                    <div class="-mx-1.5 -my-1.5">
                        <button onclick="this.closest('.bg-green-50').remove()" class="inline-flex bg-green-50 rounded-md p-1.5 text-green-500 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="coursesGrid">
            ...
            <div class="course-card bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow duration-200"
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">{{ $course->name }}</h3>
                    ...
                    <div class="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-4">
                        ...
                        {{ $course->subjects_count }} {{ Str::plural('Subject', $course->subjects_count) }}
                    </div>
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm text-gray-700">
                        Showing <span class="font-medium">1</span> to <span class="font-medium">{{ $courses->count() }}</span> of{' '}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function filterCourses() {
        ...
        courseCards.forEach(card => {
            ...
            // For now, just show all courses regardless of filter
            // You can extend this logic based on your filtering needs
            if (matchesSearch) {
