...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
        <!-- Total Questions -->
        <div class="group bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/30 rounded-xl p-2 border border-blue-200 dark:border-blue-800/50 hover:shadow-lg hover:scale-105 transition-all duration-200">
            <div class="flex flex-col">
                <div class="w-6 h-6 bg-white dark:bg-blue-900/50 rounded-lg flex items-center justify-center shadow-sm mb-1.5 group-hover:rotate-12 transition-transform duration-200">
                    <svg class="w-4 h-4 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                </div>
                <p class="text-xl md:text-2xl font-bold text-blue-600 dark:text-blue-400 leading-none" data-stat="total_questions">{{ $stats['total_questions'] }}</p>
