...
@section('title', 'Add New QCReator')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Add New QCReator</h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Create a new question creator for public exams</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('system-admin.qcreators.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="p-6 space-y-6">
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="mt-1 flex items-center">
                                <div class="bg-gray-200 dark:bg-gray-700 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl w-32 h-32 flex items-center justify-center overflow-hidden">
                                    ...
                                    <span id="photoPlaceholder" class="text-gray-500 dark:text-gray-400">
                            ...
                            <div class="mt-3">
                                ...
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Upload a photo (JPG, PNG, GIF)</p>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <textarea name="experiences" id="experiences" rows="4"
                                  class="block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white sm:text-sm px-3 py-2 border"
                                  placeholder="Enter experiences and qualifications"></textarea>
