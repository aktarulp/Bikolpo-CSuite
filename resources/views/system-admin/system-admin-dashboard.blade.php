...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-900 dark:to-gray-900">
    <div class="max-w-7xl mx-auto space-y-4 p-3 md:p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <!-- Total Users Card -->
            <div class="group relative overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-200">
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"></path>
                            </svg>
                        </div>
                        <div class="text-right">
                            <p class="text-white/80 text-sm">Growth</p>
                            <p class="text-white text-lg font-bold">+12.5%</p>
                        </div>
                    </div>
                    <h3 class="text-white/90 text-sm font-semibold mb-2">📊 Total Users</h3>
                    <p class="text-3xl font-black text-white mb-1">{{ $stats['total_students'] + $stats['total_partners'] + 1 }}</p>
                    <p class="text-white/70 text-xs">Students, Partners & Admins</p>
                </div>
            </div>

            <!-- Active Students Card -->
            <div class="group relative overflow-hidden bg-gradient-to-br from-emerald-500 to-emerald-600 dark:from-emerald-600 dark:to-emerald-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-200">
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-right">
                            <p class="text-white/80 text-sm">Today</p>
                            <p class="text-white text-lg font-bold">{{ rand(15, 45) }}</p>
                        </div>
                    </div>
                    <h3 class="text-white/90 text-sm font-semibold mb-2">🧑‍🎓 Active Students</h3>
                    <p class="text-3xl font-black text-white mb-1">{{ $stats['total_students'] }}</p>
                    <p class="text-white/70 text-xs">This Month: {{ rand(200, 500) }}</p>
                </div>
            </div>

            <!-- Active Partners Card -->
            <div class="group relative overflow-hidden bg-gradient-to-br from-purple-500 to-purple-600 dark:from-purple-600 dark:to-purple-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-200">
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-white text-lg font-bold">{{ rand(8, 15) }}</p>
                        </div>
                    </div>
                    <h3 class="text-white/90 text-sm font-semibold mb-2">🏫 Active Partners</h3>
                    <p class="text-3xl font-black text-white mb-1">{{ $stats['total_partners'] ?? rand(20, 50) }}</p>
                    <p class="text-white/70 text-xs">Coaching Centers</p>
                </div>
            </div>

            <!-- MCQ Sets Card -->
            <div class="group relative overflow-hidden bg-gradient-to-br from-orange-500 to-orange-600 dark:from-orange-600 dark:to-orange-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-200">
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-white text-lg font-bold">{{ $stats['total_exams'] }}</p>
                        </div>
                    </div>
                    <h3 class="text-white/90 text-sm font-semibold mb-2">🧠 MCQ Sets</h3>
                    <p class="text-3xl font-black text-white mb-1">{{ $stats['total_questions'] }}</p>
                    <p class="text-white/70 text-xs">Total Questions</p>
                </div>
            </div>

            <!-- Ongoing Tests Card -->
            <div class="group relative overflow-hidden bg-gradient-to-br from-cyan-500 to-cyan-600 dark:from-cyan-600 dark:to-cyan-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-200">
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-right">
                            <p class="text-white/80 text-sm">Live</p>
                            <p class="text-white text-lg font-bold">{{ rand(3, 8) }}</p>
                        </div>
                    </div>
                    <h3 class="text-white/90 text-sm font-semibold mb-2">🕒 Ongoing Tests</h3>
                    <p class="text-3xl font-black text-white mb-1">{{ rand(5, 15) }}</p>
                    <p class="text-white/70 text-xs">Active Now</p>
                </div>
            </div>

            <!-- Total Earnings Card -->
            <div class="group relative overflow-hidden bg-gradient-to-br from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-200">
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-right">
                            <p class="text-white/80 text-sm">Today</p>
                            <p class="text-white text-lg font-bold">${{ rand(150, 450) }}</p>
                        </div>
                    </div>
                    <h3 class="text-white/90 text-sm font-semibold mb-2">💰 Total Earnings</h3>
                    <p class="text-3xl font-black text-white mb-1">${{ rand(5000, 15000) }}</p>
                    <p class="text-white/70 text-xs">All Time</p>
                </div>
            </div>

            <!-- Pending Payments Card -->
            <div class="group relative overflow-hidden bg-gradient-to-br from-red-500 to-red-600 dark:from-red-600 dark:to-red-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-200">
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-white/90 text-sm font-semibold mb-2">🧾 Pending Payments</h3>
                    <p class="text-3xl font-black text-white mb-1">${{ rand(500, 2000) }}</p>
                    <p class="text-white/70 text-xs">Awaiting Processing</p>
                </div>
            </div>

            <!-- System Status Card -->
            <div class="group relative overflow-hidden bg-gradient-to-br from-indigo-500 to-indigo-600 dark:from-indigo-600 dark:to-indigo-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-200">
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-4">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center shadow">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-green-300 text-lg font-bold">✓ All Good</p>
                        </div>
                    </div>
                    <h3 class="text-white/90 text-sm font-semibold mb-2">⚡ System Status</h3>
                    <div class="space-y-1">
                        <div class="flex items-center justify-between text-xs">
                            <span class="text-white/70">Cache</span>
                        ...
                        <div class="flex items-center justify-between text-xs">
                            <span class="text-white/70">Queue</span>
                            <span class="text-green-300">✓</span>
                        </div>
                        <div class="flex items-center justify-between text-xs">
                            <span class="text-white/70">Mail</span>
                            <span class="text-green-300">✓</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-amber-800 dark:text-amber-400 text-sm mb-2">
                        There are <strong>{{ $totalQuestionsInDB }} total questions</strong> in the system, but only <strong>{{ $validQuestions }} are properly linked to courses</strong>. 
                        Questions without valid course links won't appear in the questions list or be available for exams.
                    </p>
                    <div class="flex gap-2 mt-3">
                        <button onclick="alert('System administrators can view and manage all questions through the admin panel.')" class="inline-flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white px-4 py-2 rounded-lg font-semibold text-sm transition-colors shadow-md">
                            <x-icon name="eye" class="w-4 h-4" />
                            View Questions
                        </button>
                        <button onclick="alert('To fix: Edit each question and assign it to a course. System administrators have access to all questions and courses.')" class="inline-flex items-center gap-2 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-amber-700 dark:text-amber-400 px-4 py-2 rounded-lg font-semibold text-sm transition-colors border border-amber-300 dark:border-amber-700">
