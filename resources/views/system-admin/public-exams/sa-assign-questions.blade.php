    ...
    <div class="container mx-auto px-4 py-4 space-y-2 relative" style="padding-bottom: 200px;">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <form id="filterForm" action="{{ route('system-admin.public-exams.store-assigned-questions', $exam) }}" method="POST">
                    @csrf
                    ...
                    <div class="px-4 pt-10 border-t border-gray-200 dark:border-gray-700">
                        <div class="questions-container">
                            @include('system-admin.public-exams.partials.sa-questions-grid', ['questions' => $questions, 'assignedQuestions' => $assignedQuestions, 'assignedQuestionsWithMarks' => $assignedQuestionsWithMarks, 'assignedQuestionsWithOrder' => $assignedQuestionsWithOrder])
                        </div>
                    </div>
                </form>
            </div>
