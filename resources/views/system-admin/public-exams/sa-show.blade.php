                 ...
                 <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                     <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                         <div class="flex items-center justify-between flex-wrap gap-3">
                             ...
                             <a href="{{ route('system-admin.public-exams.index') }}" 
                                    ...
                                    <div class="px-6 py-4">
                                        ...
                                        @else
                                            <div class="text-center py-8">
                                                ...
                                                <p class="text-gray-500 dark:text-gray-400 text-sm">Student assignment is managed by partners, not system administrators.</p>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                     ...
                                     <div class="px-6 py-4">
                                         ...
                                         @else
                                             <div class="text-center py-8">
                                                 ...
                                                 <p class="text-gray-500 dark:text-gray-400 text-sm">Question assignment is managed by partners, not system administrators.</p>
                                             </div>
                                         @endif
                                     </div>
                                 </div>
            ...
            <div class="space-y-6">
                 ...
                 <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                     ...
                     <div class="px-4 py-3 space-y-2">
                        <a href="{{ route('system-admin.public-exams.edit', $exam) }}" 
                        ...
                        <a href="{{ route('system-admin.public-exams.assign-questions', $exam) }}" 
                        ...
                        <form action="{{ route('system-admin.public-exams.destroy', $exam) }}" method="POST" class="block">
                            @csrf @method('DELETE')
                            <button type="submit" 
            ...
            <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="button" disabled
                   class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-gray-400 text-base font-medium text-white cursor-not-allowed sm:ml-3 sm:w-auto sm:text-sm">
                    Assign Questions (Partner Feature)
                </button>
