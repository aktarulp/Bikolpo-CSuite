    ...
    <div class="max-w-4xl mx-auto space-y-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow border border-gray-200 dark:border-gray-700">
            <div class="p-4 sm:p-6">
                <form id="examCreateForm" action="{{ route('system-admin.public-exams.store') }}" method="POST" class="space-y-5">
                    @csrf
                            ...
                            <div class="relative">
                                <select name="qcreator_id" 
                                    ...
                                    @foreach($qcreators as $qcreator)
                                        <option value="{{ $qcreator->id }}" {{ old('qcreator_id') == $qcreator->id ? 'selected' : '' }}>
                                            {{ $qcreator->full_name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <!-- Hidden Exam Type - Always Online -->
                        <input type="hidden" name="exam_type" value="online">
                    ...
                    <div class="space-y-3 pt-2">
                        <h3 class="text-sm font-bold text-gray-900 dark:text-white flex items-center gap-2">
                            <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.996.608 2.296.07 2.572-1.065z"></path>
