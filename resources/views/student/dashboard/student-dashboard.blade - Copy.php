...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
    ...
    <div class="px-4 sm:px-6 lg:px-8 pb-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Enrollment Status -->
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm hover:shadow-md transition-all duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400 font-medium">Enrollment</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm hover:shadow-md transition-all duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400 font-medium">Course</p>
                        <p class="text-lg font-bold text-gray-900 dark:text-white mt-1 truncate max-w-[160px]">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm hover:shadow-md transition-all duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400 font-medium">Batch</p>
                        <p class="text-lg font-bold text-gray-900 dark:text-white mt-1 truncate max-w-[160px]">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm hover:shadow-md transition-all duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400 font-medium">Learning Strike</p>
                        <p class="text-lg font-bold text-gray-900 dark:text-white mt-1">
    ...
    <div class="px-4 sm:px-6 lg:px-8 pb-10 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <div class="mt-3">
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                        <div class="bg-gradient-to-r from-purple-500 to-purple-600 h-2.5 rounded-full" style="width: {{ min(($stats['average_score'] ?? 0), 100) }}%"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <!-- Course Information -->
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm hover:shadow-md transition-all duration-300">
                            ...
                            @forelse($subjectProgress ?? collect() as $sp)
                                <div>
                                    <div class="flex items-center justify-between text-sm mb-1">
                                        ...
                                        <span class="text-gray-600 dark:text-gray-400">{{ number_format($sp['percent'], 1) }}%</span>
                                    </div>
                                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                                        <div class="bg-gradient-to-r from-indigo-500 to-indigo-600 h-2.5 rounded-full" style="width: {{ $sp['percent'] }}%"></div>
                                    </div>
                                </div>
                            @empty
            ...
            <div class="space-y-6">
                <!-- Rankings -->
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm hover:shadow-md transition-all duration-300">
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4">My Standings</h2>
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-700/30">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-10 h-10 rounded-xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center mr-3">
                            ...
                            <span class="text-sm font-bold text-gray-900 dark:text-white">{{ $stats['course_rank'] ?? '—' }}</span>
                        </div>
                        
                        <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-700/30">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-10 h-10 rounded-xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center mr-3">
                            ...
                            <span class="text-sm font-bold text-gray-900 dark:text-white">{{ $stats['batch_rank'] ?? '—' }}</span>
                        </div>
                        
                        <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-700/30">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-10 h-10 rounded-xl bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center mr-3">
                            ...
                            <span class="text-sm font-bold text-gray-900 dark:text-white">{{ $stats['batchmate_exam_faced'] ?? 0 }}</span>
                        </div>
                    </div>
                </div>

                <!-- Recent Results -->
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        @if(($recent_results ?? collect())->count() > 0)
                            <div class="space-y-4">
                                @foreach(($recent_results ?? collect())->take(4) as $result)
                                    <div class="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/30">
                                        <div class="flex-1 min-w-0">
                                            <h3 class="text-sm font-bold text-gray-900 dark:text-white truncate">{{ $result->exam->title }}</h3>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                                {{ optional($result->completed_at)->format('M d, Y') }}
                                            </p>
                                        </div>
                                        <div class="ml-4 text-right">
                                            <p class="text-sm font-bold text-gray-900 dark:text-white">{{ number_format($result->percentage ?? 0, 1) }}%</p>
                            ...
                            <div class="text-center py-8">
                                ...
                                <div class="mt-4">
                                    <a href="{{ route('student.exams.available') }}" 
                                       class="inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700">
                                        Take Exam
                                    </a>
                                </div>
                            </div>
