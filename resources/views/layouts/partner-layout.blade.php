	...
	<header class="bg-primaryGreen dark:bg-green-800 text-white shadow-lg sticky top-0 z-50">
		<div class="max-w-7xl mx-auto px-4 flex justify-between items-center py-4">
			...
			<div class="flex items-center gap-3">
				...
				<!-- Notification Bell -->
				<button id="notificationBell" class="relative bg-white text-black dark:bg-gray-700 dark:text-white p-2 rounded-full shadow hover:scale-110 transition-transform" 
				...
				<div class="relative" x-data="{ open: false }">
					<button @click="open = !open" 
							class="flex items-center space-x-2 bg-white text-black dark:bg-gray-700 dark:text-white p-2 rounded-full shadow hover:scale-110 transition-transform"
							aria-label="Profile menu" title="Profile">
						<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					...
					<div x-show="open" 
						...
						<form method="POST" action="{{ route('logout') }}">
							@csrf
							<button type="submit" 
									class="w-full text-left block px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
								<div class="flex items-center space-x-2">
									<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
