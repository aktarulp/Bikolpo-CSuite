...
<head>
    ...
    <style>
        ...
        @media (max-width: 1023px) {
            ...
            .sticky-top-bar .space-x-3 > * + * {
                margin-left: 0.25rem;
            }
            
            /* Ensure buttons don't shrink on mobile */
            .sticky-top-bar .flex.items-center.space-x-3 button,
            .sticky-top-bar .flex.items-center.space-x-3 .relative {
                flex-shrink: 0;
                min-width: auto;
            }
            
            /* Force horizontal layout for action buttons */
            .sticky-top-bar .flex.items-center.space-x-3 {
            ...
            .sticky-top-bar .text-lg {
                font-size: 1rem;
            }
            
            .sticky-top-bar .text-xs {
                font-size: 0.75rem;
            }
            
            .sticky-top-bar .w-8.h-8 {
                width: 2rem;
                height: 2rem;
            }
            
            .sticky-top-bar .w-6.h-6 {
                width: 1.5rem;
                height: 1.5rem;
            }
            
            .sticky-top-bar .w-3.h-3 {
                width: 0.75rem;
                height: 0.75rem;
            }
            
            /* Ensure dividers are visible on mobile */
            .sticky-top-bar .w-px {
                display: block !important;
            }
            
            .sticky-top-bar .space-x-2 > * + * {
                margin-left: 0.5rem;
            }
