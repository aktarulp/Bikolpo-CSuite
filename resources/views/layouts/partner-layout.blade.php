            ...
            <div class="flex flex-col flex-grow pt-5 h-full overflow-y-auto">
                ...
                <nav class="flex-1 px-4">
                    ...
                    <a href="{{ route('partner.questions.drafts') }}"
                       class="group flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('partner.questions.drafts') ? 'bg-yellow-100 text-yellow-800 border border-yellow-200' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                        <svg class="h-5 w-5 {{ request()->routeIs('partner.questions.drafts') ? 'text-yellow-600' : 'text-gray-400 group-hover:text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        <span class="ml-3 transition-all duration-300">Drafts</span>
                    </a>
