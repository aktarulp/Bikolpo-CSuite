        ...
        <aside id="sidebar"
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('partner.question-history.index') }}" 
                   class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-primaryGreen hover:text-white transition-colors duration-200 {{ request()->routeIs('partner.question-history.*') ? 'bg-primaryGreen text-white' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
