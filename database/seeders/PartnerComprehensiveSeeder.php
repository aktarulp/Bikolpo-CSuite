...
class PartnerComprehensiveSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($partners as $partner) {
            // Generate slug safely - use partner name if user_id is null
            $slug = $partner->user_id ? 
                Str::slug($partner->user->name ?? 'partner-' . $partner->id) : 
                Str::slug($partner->name ?? 'partner-' . $partner->id);
