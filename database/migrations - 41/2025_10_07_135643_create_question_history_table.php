...
class CreateQuestionHistoryTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('question_history', function (Blueprint $table) {
            ...
            $table->foreign('created_by', 'question_history_created_by_foreign')->references('id')->on('users')->onDelete('set NULL');
            $table->foreign('partner_id', 'question_history_partner_id_foreign')->references('id')->on('partners')->onDelete('cascade');
            $table->foreign('question_id', 'question_history_question_id_foreign')->references('id')->on('questions')->onDelete('cascade');
        });
    }
