...
class CreateQuestionTypesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('question_types', function (Blueprint $table) {
            ...
            $table->foreign('created_by', 'question_types_created_by_foreign')->references('id')->on('users')->onDelete('set NULL');
            $table->foreign('partner_id', 'question_types_partner_id_foreign')->references('id')->on('partners')->onDelete('set NULL');
        });
    }
