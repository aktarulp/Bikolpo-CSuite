...
class CreateAcPermissionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ac_permissions', function (Blueprint $table) {
            ...
            $table->foreign('created_by', 'permissions_created_by_foreign')->references('id')->on('ac_users')->onDelete('set NULL');
            $table->foreign('updated_by', 'permissions_updated_by_foreign')->references('id')->on('ac_users')->onDelete('set NULL');
        });
    }
